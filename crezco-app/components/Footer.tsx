        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/projects" className="text-sm text-gray-600 hover:text-purple-600 transition-colors">
                  Explorar
                </Link>
              </li>
              <li>
                <Link href="/create" className="text-sm text-gray-600 hover:text-purple-600 transition-colors">
                  Crear Proyecto
                </Link>
              </li>
              <li>
